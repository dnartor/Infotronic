...
raton1 = Product.create(name: 'Ratón gaming - Razer Naga Trinity', description: '16000DPI, USB, Óptico, 19 botones personalizables, Negro y verde', price:80, onsale: false, category_id:4, brand_id:5)
raton2 = Product.create(name: 'Logitech G502', description: 'Hero Ratón Gaming 16000DPI, negro', price:54, onsale: false, category_id:4, brand_id:4)
