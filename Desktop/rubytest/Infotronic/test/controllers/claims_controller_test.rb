...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { account_id: @claim.account_id, description: @claim.description } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { account_id: @claim.account_id, description: @claim.description } }
